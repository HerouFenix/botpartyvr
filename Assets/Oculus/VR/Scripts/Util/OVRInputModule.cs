...
namespace UnityEngine.EventSystems
{
    ...
    public class OVRInputModule : PointerInputModule
    {
        ...
        private OVRBone _indexPreviousFinger;
...
#region PointerEventData pool
        ...
        virtual protected MouseState GetGazePointerData()
        {
            ...
            if(hand == null)
                ...
                leftData.worldSpaceRay = new Ray(hand.PointerPose.position, hand.PointerPose.forward);
            ...
            if (hand == null)
                ...
                m_Cursor.SetCursorRay(hand.PointerPose);
            ...
            if (ovrRaycaster)
            {
                ...
                if (graphicRect != null)
                {
                    ...
                    if (hand == null)
                        ...
                        m_Cursor.SetCursorStartDest(hand.PointerPose.position, worldPos, normal);
            ...
            if (physicsRaycaster)
            {
                ...
                if (hand == null)
                    ...
                    m_Cursor.SetCursorStartDest(hand.PointerPose.position, position, raycast.worldNormal);
