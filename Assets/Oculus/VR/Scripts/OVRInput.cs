...
public static class OVRInput
{
    ...
    /// </summary>
    public static void Update(bool disableControllers = false)
    {
        ...
        if (((activeControllerType == Controller.LTouch) || (activeControllerType == Controller.RTouch)) && !disableControllers)
        {
        ...
        if ((activeControllerType == Controller.LHand) || (activeControllerType == Controller.RHand) || disableControllers)
        {
